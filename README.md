...
- **Idempotent Setup**: A script to configure the firewall and install Dokploy using the official installer.
- **Advanced CI/CD**: Adopted from [yxtay/dotfiles](https://github.com/yxtay/dotfiles), including:
    - **MegaLinter**: Comprehensive linting with automatic fixes.
    - **OSSF Scorecard**: Security health checks.
    - **Automerge**: Automated merging for trusted bots.
    - **Semantic PRs**: Title linting for better history.
